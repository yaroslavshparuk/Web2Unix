...
namespace Web2Unix.Infrastructure.Migrations
{
    ...
    [Migration("20230409101129_ChangeHostnameToServerNameInServerEntity")]
    partial class ChangeHostnameToServerNameInServerEntity
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Web2Unix.Domain.Entities.WebUser", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTimeOffset(new DateTime(2023, 4, 9, 10, 11, 29, 457, DateTimeKind.Unspecified).AddTicks(5613), new TimeSpan(0, 0, 0, 0, 0)),
                            Email = "shparuk1996@gmail.com",
                            PasswordHash = new byte[] { 0 },
                            PasswordSalt = new byte[] { 0 },
                            UpdatedAt = new DateTimeOffset(new DateTime(2023, 4, 9, 10, 11, 29, 457, DateTimeKind.Unspecified).AddTicks(5624), new TimeSpan(0, 0, 0, 0, 0)),
                            Username = "yaroslav"
                        });
                });
